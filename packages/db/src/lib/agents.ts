...
export async function getAgentById(id: string) {
  try {
    ...
    return {
      id: agent[0][0],
      organization_id: agent[0][1],
      name: agent[0][2],
      description: agent[0][3],
      status: agent[0][4],
      version: agent[0][5],
      created_at: agent[0][6],
      updated_at: agent[0][7],
      last_active: agent[0][8],
      container_id: agent[0][9],
      deployment_count: agent[0][10],
      configuration: agent[0][11],
      metadata: agent[0][12],
      envVars,
      integrations,
      deployments,
